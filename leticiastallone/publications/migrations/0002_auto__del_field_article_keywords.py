...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'publications_article', 'keywords')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Article.keywords'
        raise RuntimeError("Cannot reverse this migration. 'Article.keywords' and its values cannot be restored.")
